...
import static az.ingress.model.consrants.ExceptionConstants.HTTP_REQUEST_METHOD_NOT_SUPPORTED_EXCEPTION;
...
public class ErrorHandler {
    ...
    public ErrorResponse handle(HttpRequestMethodNotSupportedException ex) {
        log.error("ActionLog.handle.error", ex);
        return new ErrorResponse(HTTP_REQUEST_METHOD_NOT_SUPPORTED_EXCEPTION.getMessage(), HTTP_REQUEST_METHOD_NOT_SUPPORTED_EXCEPTION.getCode());
    }
}
